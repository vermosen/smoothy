...
namespace testsuite {
  ...
  boost::unit_test_framework::test_suite* optimization_test::suite() {
      boost::unit_test_framework::test_suite* suite = BOOST_TEST_SUITE("optimization");
      suite->add(BOOST_TEST_CASE(&optimization_test::rosenbrock_values     ), 0, MAX_TIME_SEC);
      suite->add(BOOST_TEST_CASE(&optimization_test::set_criteria          ), 0, MAX_TIME_SEC);
      suite->add(BOOST_TEST_CASE(&optimization_test::set_problem           ), 0, MAX_TIME_SEC);
      suite->add(BOOST_TEST_CASE(&optimization_test::armijogoldstein_stride), 0, MAX_TIME_SEC);
      return suite;
  }
  ...
  void optimization_test::rosenbrock_values() {
  ...
  void optimization_test::set_criteria() {
  ...
  void optimization_test::set_problem() {
  ...
  void optimization_test::armijogoldstein_stride() {
